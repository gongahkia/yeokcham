...
- [ADR-067 — browser passkey PRF vault and origin-bound local custody](docs/adr/067-browser-passkey-prf-vault.md) — Superseded by ADR-073.
- [ADR-068 — offline recovery package and explicit replacement-device proposal](docs/adr/068-offline-recovery-package.md) — Superseded by ADR-073.
- [ADR-069 — bounded local secure-runtime IPC contract](docs/adr/069-v2-secure-runtime-ipc.md) — Superseded by ADR-073.
- [ADR-070 — V2 repository MLS bootstrap](docs/adr/070-v2-repository-mls-bootstrap.md) — Superseded by ADR-073.
- [ADR-071 — V2 MLS member invitations and device join](docs/adr/071-v2-mls-member-invitations.md) — Superseded by ADR-073.
...
- [ADR-084 — V4 branching authority epochs and recovery](docs/adr/084-v4-branching-authority-epochs-and-recovery.md) — Accepted.
