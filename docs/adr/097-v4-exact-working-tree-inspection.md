# ADR-097 — V4 exact working-tree inspection
...
It must preserve the V4 boundary between local scratch and explicit shared
history.

## Current milestone and vertical slice

V4 onboarding and exact local inspection. The slice adds one local observation
