# ADR-084 — V1 branching authority epochs and recovery
...
V1 authority is an immutable, signed graph of canonical `Authority_epoch_v1`
...
V1 gains a flexible small-team trust lifecycle without TOFU, global authority
