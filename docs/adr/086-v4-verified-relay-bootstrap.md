# ADR-086 — V4 verified relay bootstrap
...
V4 relay sync is deliberately receipt between already-equivalent replicas. A
...
package-manifest-v1 digest, a canonical portable V4 state, and the publisher
