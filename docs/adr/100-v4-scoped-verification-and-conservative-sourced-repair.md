# ADR-100 — V4 scoped verification and conservative sourced repair
...
- [ADR-090 durable restore proofs](090-v4-durable-restore-proofs.md)
- [ADR-091 local recoverable garbage collection](091-v4-local-recoverable-garbage-collection.md)
- [ADR-098 explicit projection workspace](098-v4-explicit-projection-workspace.md)
