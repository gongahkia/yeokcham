# ADR-098 — V4 explicit projection workspace activation and update
...
V4's projection is not a clone, a branch checkout, a delivery, or an authority
...
record before it publishes its initial V4 state head. The record names the
