# ADR-092 — V1 exact decision-proposal assistance

- Status: Accepted
- Date: 2026-08-30
- Deciders: maintainers
- Implements: [#260](https://github.com/gongahkia/yeokcham/issues/260)
- Depends on: ADR-079 and the V1 decision/resolution model

## Context

An open V1 decision is durable evidence that visible shared revisions cannot
...
V1 adds a parser-free, ephemeral proposal calculation for a pair of revisions
...
the V1 project state, signed revision, resolution record, package, relay,
