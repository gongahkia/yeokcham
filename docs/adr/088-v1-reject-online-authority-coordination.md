# ADR-088 — V1 rejects online authority coordination
...
V1 authority is a locally verified, immutable graph of signed authority epochs.
...
This ADR evaluates whether V1 should replace or supplement that model with
...
V1 rejects online authority coordination. No network service, quorum, lease,
...
epoch may perform V1 authority actions while disconnected. Concurrent results
...
cannot make a locally valid V1 transition invalid or unavailable. It must not
...
rotation, or recovery would become unavailable precisely when V1 currently
...
would add all of those policies and turn individually inspectable V1 authority
...
authority without becoming a coordinator. V1 may consider such audit evidence
separately, but it has no authority effect.

## Invariants

1. V1 authority validity is determined solely by locally verified canonical
...
V1 retains its present cost: administrator disagreement can create an authority
