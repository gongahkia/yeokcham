...
let partial_prefix = ".yeokcham-bundle-v1-"
let partial_suffix = ".partial"
let complete_prefix = "yeokcham-bundle-v1-"
let complete_suffix = ".yeok"
let token_length = 32
let ( let* ) = Result.bind
                ...
                (Unsafe_entry
                   {
                     ...
                     detail = "entry name is not a Yeokcham bundle v1 name";
                   })
...
let inspect ~key complete =
  ...
  in
  let* plaintext =
    Bundle.open_bundle ~repository_format:Yeokcham_store.repository_format ~key
      bundle
