(** Local V1 saved-work transitions and verified offline-package receive.
...
type error =
  ...
  | Restore_journal_error of Yeokcham_v1_restore_journal.error
  | Restore_proof_error of Yeokcham_v1_restore_proof.error
  ...
  | Recovery_error of Yeokcham_v1_recovery.error
  | Transport_error of Yeokcham_v1_transport.error
  | Workspace_error of Yeokcham_v1_workspace.error
  | Workspace_refusal of Yeokcham_v1_workspace.refusal
  | Proposal_error of Yeokcham_v1_proposal.tree_error
  | Proposal_refused of Yeokcham_v1_proposal.refusal list
  | Stale_proposal of {
      decision : Yeokcham_v1_model.Decision_id.t;
      left : Yeokcham_v1_model.Revision_id.t;
      right : Yeokcham_v1_model.Revision_id.t;
  ...
  | Unknown_checkpoint of Yeokcham_v1_model.Snapshot_id.t
  | Unchanged_share of Yeokcham_v1_model.Snapshot_id.t
  | Unsigned_project

and proposal_staleness =
  | Decision_not_open
  | Candidate_not_in_decision of Yeokcham_v1_model.Revision_id.t
...
type inspection_state = {
  inspection_project : Yeokcham_v1_model.project;
  inspection_signed_revisions : Yeokcham_v1_trust.signed_revision list;
  inspection_authority : Yeokcham_v1_trust.authority option;
  inspection_review_publications : string list;
}
(** A read-only projection input loaded from the current V1 state. It neither
...
type identity = {
  repository : Yeokcham_v1_trust.Repository_id.t;
  device : Yeokcham_v1_trust.device;
  role : Yeokcham_v1_trust.role;
}

type materialized_candidate = {
  revision : Yeokcham_v1_model.Revision_id.t;
  author : Yeokcham_v1_model.Device_id.t;
  username : Yeokcham_v1_model.Username.t option;
  directory : string;
}
...
type decision_proposal = Yeokcham_v1_proposal.t
...
type semantic_advice =
  ...
  | Semantic_report of Yeokcham_v1_lsp_sidecar.report
...
type working_tree_comparison = {
  saved_checkpoint : Yeokcham_v1_model.Snapshot_id.t;
  observed_snapshot : Yeokcham_v1_model.Snapshot_id.t;
...
type comparison_target =
  | Baseline
  | Candidate of Yeokcham_v1_model.Revision_id.t

type decision_comparison = {
  compared_decision : Yeokcham_v1_model.decision;
  compared_candidate : Yeokcham_v1_model.change_revision;
  against : Yeokcham_v1_model.Snapshot_id.t;
  differences : path_difference list;
}
...
type inspected_candidate = {
  inspected_revision : Yeokcham_v1_model.change_revision;
  inspected_username : Yeokcham_v1_model.Username.t option;
}

type decision_inspection = {
  inspected_decision : Yeokcham_v1_model.decision;
  inspected_candidates : inspected_candidate list;
}

type package_review = {
  review_revision : Yeokcham_v1_model.Revision_id.t;
  review_author : Yeokcham_v1_model.Device_id.t;
...
type compact_report = {
  kept : Yeokcham_v1_model.compact_keep list;
  dropped : Yeokcham_v1_model.Snapshot_id.t list;
...
type restore_proof = {
  ...
  proof_safety : Yeokcham_v1_model.Snapshot_id.t;
  proof_target : Yeokcham_v1_model.Snapshot_id.t;
}

type storage_root = {
  root_snapshot : Yeokcham_v1_model.Snapshot_id.t;
  root_reasons : Yeokcham_v1_model.protection_reason list;
}
...
type transport_outbound = {
  outbound_publication : Yeokcham_v1_transport.publication;
  outbound_artifact : Yeokcham_v1_package.artifact;
  outbound_revisions : Yeokcham_v1_model.Revision_id.t list;
}

type bootstrap_outbound = {
  bootstrap_basis : Yeokcham_v1_bootstrap.basis;
  bootstrap_artifact : Yeokcham_v1_package.artifact;
}
...
type in_place_restore = {
  ...
  safety_checkpoint : Yeokcham_v1_model.Snapshot_id.t;
  restored_checkpoint : Yeokcham_v1_model.Snapshot_id.t;
  resumed : bool;
}

type workspace_materialization = {
  workspace_basis : Yeokcham_v1_workspace.projection_basis;
  workspace_receipt : Yeokcham_v1_workspace.workspace_projection_receipt;
  workspace_safety_checkpoint : Yeokcham_v1_model.Snapshot_id.t option;
...
type workspace_update =
  | Workspace_already_current of
      Yeokcham_v1_workspace.workspace_projection_receipt
...
val init :
  root:string ->
  creator:Yeokcham_v1_model.Device_id.t ->
  username:Yeokcham_v1_model.Username.t ->
  initial_draft:Yeokcham_v1_model.Draft_id.t ->
  title:string ->
  (status, error) result
...
val init_signed :
  ...
  repository:Yeokcham_v1_trust.Repository_id.t ->
  device:Yeokcham_v1_trust.device ->
  signing_capability:Yeokcham_v1_trust.signing_capability ->
  (status, error) result
(** Initializes a collaboration-capable V1 state. [device] is the initial
...
val init_signed_with_recovery :
  ...
  device:Yeokcham_v1_trust.device ->
  signing_capability:Yeokcham_v1_trust.signing_capability ->
  recovery_device:Yeokcham_v1_trust.device ->
  recovery_capability:Yeokcham_v1_trust.signing_capability ->
  (status * Yeokcham_v1_recovery.ceremony, error) result
(** Creates the root authority epoch and its initial encrypted recovery package
    before publishing the first V1 state. The caller must present the returned
...
(** Initializes an already enrolled device from public collaboration state. The
    caller keeps the corresponding private signing capability outside V1 project
    objects. *)
...
val init_authority_collaboration :
  ...
  local_certificate:string ->
  (status, error) result
(** Initializes an already-enrolled device using a verified V1 authority
...
val bootstrap_from_package :
  ...
  local_certificate:string ->
  (status, error) result
(** Verifies an immutable bootstrap basis and creates a fresh local V1 state. It
...
val register_username :
  root:string ->
  device:Yeokcham_v1_model.Device_id.t ->
  username:Yeokcham_v1_model.Username.t ->
  (status, error) result
...
val enroll_device :
  ...
  root:string ->
  subject:Yeokcham_v1_trust.device ->
  role:Yeokcham_v1_trust.role ->
  username:Yeokcham_v1_model.Username.t ->
  signing_capability:Yeokcham_v1_trust.signing_capability ->
  (status, error) result
...
val rotate_local_device :
  parent:string option ->
  root:string ->
  replacement:Yeokcham_v1_trust.device ->
  signing_capability:Yeokcham_v1_trust.signing_capability ->
  (status, error) result
...
val recover_authority :
  ...
  output:string ->
  replacement:Yeokcham_v1_trust.device ->
  replaced:Yeokcham_v1_model.Device_id.t ->
  (status * Yeokcham_v1_recovery.ceremony, error) result
...
val new_draft :
  root:string ->
  id:Yeokcham_v1_model.Draft_id.t ->
  title:string ->
  (status, error) result

val share :
  root:string ->
  change:Yeokcham_v1_model.Change_id.t ->
  revision:Yeokcham_v1_model.Revision_id.t ->
  (status, error) result
...
val withdraw :
  root:string -> change:Yeokcham_v1_model.Change_id.t -> (status, error) result
...
(** Imports only verified immutable objects and then atomically advances the
    collaborative V1 state. It does not materialize or otherwise touch the
    working tree. *)
...
val record_transport_outbound :
  ...
  remote:string ->
  publication:Yeokcham_v1_transport.publication ->
  revisions:Yeokcham_v1_model.Revision_id.t list ->
  (unit, error) result
(** Atomically records a relay-acknowledged publication and its announced
    revision identities with the V1 collaborative state. *)
...
val open_decision :
  root:string ->
  decision:Yeokcham_v1_model.Decision_id.t ->
  (Yeokcham_v1_model.decision, error) result
...
val proposal_pairs :
  root:string ->
  decision:Yeokcham_v1_model.Decision_id.t ->
  ( (Yeokcham_v1_model.Revision_id.t * Yeokcham_v1_model.Revision_id.t) list,
    error )
  result
...
val compare_decision :
  root:string ->
  decision:Yeokcham_v1_model.Decision_id.t ->
  candidate:Yeokcham_v1_model.Revision_id.t ->
...
val deliver :
  root:string ->
  id:Yeokcham_v1_model.Delivery_id.t ->
  next_draft:Yeokcham_v1_model.Draft_id.t ->
  next_title:string ->
  (status, error) result
