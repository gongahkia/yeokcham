...
module V2 : sig
  type error =
    ...
    | Wire_error of Yeokcham_v1_transport.V2_wire.error
  ...
  val negotiate_upload :
    client ->
    project:string ->
    sender:Yeokcham_v1_transport.V2.capability ->
    offered:string list ->
    (Yeokcham_v1_transport.V2.capability, error) result
  ...
  (** Returns only a fully reassembled, canonical, identity-checked object. It
      does not import the bytes into a V1 store. *)
end
