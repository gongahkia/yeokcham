...
type error =
  ...
  | Ref_event_store_error of Yeokcham_ref_event_store.error
...
val store_set :
  Yeokcham_store.repository -> Divergence.t -> (Object_id.t, error) result

val load_set :
  Yeokcham_store.repository -> Object_id.t -> (Divergence.t, error) result
