...
type error =
  | Hook_error of Yeokcham_v4_hook.error
...
val load : root:string -> (Yeokcham_v4_hook.registry, error) result
val save : root:string -> Yeokcham_v4_hook.registry -> (unit, error) result
