...
let error_to_string = function
  | Invalid_basis_id value -> "invalid V4 projection basis identifier: " ^ value
  | Invalid_tree_id value -> "invalid V4 projection tree identifier: " ^ value
  | Invalid_source_fingerprint value ->
      "invalid V4 projection source fingerprint: " ^ value
  | Source_fingerprint_mismatch ->
      "V4 projection source fingerprint does not bind the canonical tree"
  | Invalid_generation value ->
      Printf.sprintf "invalid V4 workspace activation generation: %Ld" value
  | Encoding_error error -> Encoding.construction_error_to_string error
  | Decode_error error -> Encoding.decode_error_to_string error
  | Invalid_schema detail -> "invalid V4 workspace record: " ^ detail
  | Unsupported_schema_version version ->
      Printf.sprintf "unsupported V4 workspace record version: %Ld" version
