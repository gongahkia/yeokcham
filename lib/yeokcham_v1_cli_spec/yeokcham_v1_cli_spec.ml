...
let render_bash () =
  ...
  in
  "# bash completion for yeokcham; generated from Yeokcham_v1_cli_spec\n\
   _yeokcham() {\n\
...
let render_zsh () =
  ...
  in
  "#compdef yeokcham\n\
   # zsh completion for yeokcham; generated from Yeokcham_v1_cli_spec\n\
   _yeokcham() {\n\
   local -a candidates\n\
   candidates=(\n" ^ entries
...
let render_fish () =
  ...
  let entries =
    ...
    |> String.concat "\n"
  in
  "# fish completion for yeokcham; generated from Yeokcham_v1_cli_spec\n\
