...
type fixture = {
  ...
  semantic_anchor : Yeokcham_semantic_retarget.anchor;
  semantic_candidates : Yeokcham_semantic_retarget.candidate list;
  expected_target_span : Yeokcham_textual_patch.span option;
  expected_outcome : expected_outcome;
  acceptable_confidence_ceiling : Yeokcham_semantic_retarget.confidence;
...
val semantic_result : fixture -> Yeokcham_semantic_retarget.result
