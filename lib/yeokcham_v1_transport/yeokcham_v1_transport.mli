(** Canonical V1 relay-publication records and local transport bookkeeping.
    ...
    this pure module before handing package bytes to the V1 package verifier. *)
...
module V2 : sig
  (** Pure V2 relay-transfer planning. These values describe only raw immutable
      bytes and relay-local sessions; they are not V1 history or state. *)
