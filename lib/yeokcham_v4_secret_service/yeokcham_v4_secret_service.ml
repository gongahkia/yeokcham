...
let schema = "v4-device-signing-1"
let label = "Yeokcham V4 device signing key"
let secret_prefix = "yeokcham-v4-ed25519-1:"
...
let error_to_string = function
  ...
  | Secret_missing ->
      "local V4 signing key is missing from Linux Secret Service"
  | Secret_conflict ->
      "Linux Secret Service already contains different material for this V4 \
       device"
  | Invalid_secret_material ->
      "Linux Secret Service returned invalid V4 signing material"
