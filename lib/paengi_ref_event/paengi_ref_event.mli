...
val unsigned_payload : unsigned -> (Paengi_encoding.t, error) result
...
val event_payload : t -> (Paengi_encoding.t, error) result
val decode_event_payload : Paengi_encoding.t -> (t, error) result
