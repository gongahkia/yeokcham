...
CAMLprim value caml_yeokcham_v1_macos_keychain_lookup(value service, value account) {
...
CAMLprim value caml_yeokcham_v1_macos_keychain_store(value service, value account, value contents) {
  ...
  CFDictionarySetValue(query, kSecAttrLabel, CFSTR("Yeokcham V1 device signing key"));
