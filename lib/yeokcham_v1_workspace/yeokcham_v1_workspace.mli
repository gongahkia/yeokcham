(** Explicit local materialisation metadata for a verified V1 projection.

    This module is deliberately outside the V1 [Project], authority, package,
...
val make_projection_basis :
  ...
  snapshot:Yeokcham_v1_model.Snapshot_id.t ->
  canonical_tree:string ->
  source_fingerprint:string ->
  (projection_basis, error) result

val basis_repository : projection_basis -> Yeokcham_v1_trust.Repository_id.t
val basis_imported_basis_id : projection_basis -> string
val basis_snapshot : projection_basis -> Yeokcham_v1_model.Snapshot_id.t
...
val receipt_repository :
  workspace_projection_receipt -> Yeokcham_v1_trust.Repository_id.t

val receipt_imported_basis_id : workspace_projection_receipt -> string

val receipt_snapshot :
  workspace_projection_receipt -> Yeokcham_v1_model.Snapshot_id.t
