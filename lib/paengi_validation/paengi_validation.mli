...
val evidence_stdout_output : evidence -> Paengi_store.Stored_object_id.t option
val evidence_stderr_output : evidence -> Paengi_store.Stored_object_id.t option
...
val create_evidence :
  ...
  stdout_output:Paengi_store.Stored_object_id.t option ->
  stderr_output:Paengi_store.Stored_object_id.t option ->
  observed_at:int64 ->
