module Device_id = Yeokcham_id.Device_id
...
type resolution =
  ...
  | Device_unmapped of Yeokcham_ref_event.signer_key_id
  | Device_ambiguous of {
      signer_key_id : Yeokcham_ref_event.signer_key_id;
...
val signer_key_id_to_hex : Yeokcham_ref_event.signer_key_id -> string
...
val signer_key_id : t -> Yeokcham_ref_event.signer_key_id
val public_key : t -> string
val mandatory_features : t -> int64
val identity_equal : t -> t -> bool
val identity_payload : t -> (Yeokcham_encoding.t, error) result
val decode_identity_payload : Yeokcham_encoding.t -> (t, error) result
val identity_envelope : t -> (Yeokcham_envelope.t, error) result
...
val resolve_verified : registry -> Yeokcham_ref_event.verified -> resolution
