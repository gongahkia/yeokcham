...
let valid_fixtures_are_exact_and_canonical () =
  ...
  ignore (canonical_object "v2-object-validation-evidence-frame-v1.cbor.hex");
  ignore (canonical_object "v2-object-release-frame-v1.cbor.hex");
  let ledger_envelope =
