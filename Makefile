...
.PHONY: setup deps build test lint format ci workflow-security-test workflow-ci-test evidence-fixture-test evidence-workspace-benchmark-test linux-watch-test relay-container-test development-artifact-test development-build-record-test release-verify release-verify-test
...
ci: lint test workflow-security-test workflow-ci-test evidence-fixture-test evidence-workspace-benchmark-test
